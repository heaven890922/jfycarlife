  ...
  <div style="height:30px; font-size:18px;">添加收货人信息</div></h1>
    ...
    <div class="jfycontent">
      <div id="container">
         ...
         <a href="#" class="ui-btn ui-corner-all" style=" border-color:#88cc44; color:#88cc44; width:76%; margin:auto;  padding: 0.5em 1em;" onClick="addAdress()">保存地址</a> 
      </div>    
    </div><!--ebd content-->
</div>
<?
