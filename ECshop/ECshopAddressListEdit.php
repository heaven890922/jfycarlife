	...
	$.ajax({  
			...
			success: function(msg){
				...
				<?
					if($flag){
				?>
				location.href="ECshopOrderNow.php?id=<?=$id?>&gdetailid=<?=$gdetailid?>&sdnum=<?=$sdnum?>";	
				<?
					}else{
				?>
				location.href="ECshopOrder.php?id=<?=$id?>";
  ...
  <div style="height:30px; font-size:18px;">添加收货人信息</div></h1>
    ...
    <div class="jfycontent">
	  ...
	  ?>
         ...
         <a href="#" class="ui-btn ui-corner-all" style=" border-color:#88cc44; color:#88cc44; width:76%; margin:auto;  padding: 0.5em 1em;" onClick="UpdateAdress()">保存并使用</a>
         <?
			}else{
		 ?>
