...
$sql="SELECT o.orderid,o.ordertime,o.paystate,o.money,o.ordernum,o.remarks,o.address,o.phone,o.`name`,o.expressPrice,o.orderstate,d.price,d.num,gd.dpic,gd.dname,gs.gdname FROM sh_store_order o JOIN sh_store_order_detail d ON o.orderid=d.orderid JOIN sh_store_goods_detail gd ON d.goodsid=gd.detailid JOIN sh_store_goods gs ON gd.gdid=gs.gdid WHERE ordernum ='$orderNum'  AND userid=$userID and o.delstate='N' ";
...
?>
<h1>
  <div style="height:30px; font-size:18px;">订单详情</div></h1>
    ...
    <!--所选商品展示开始-->   
    	...
    	<div id="container"> 
           ...
           <?
		   		if($dataTable[0]['orderstate']=='FORCANCEL'){
					$pstr="退款审核中";
					$class="order_info";
				}elseif($dataTable[0]['orderstate']=='WDELIVER'){
					$pstr="待发货";
					$class="back";	
				}elseif($dataTable[0]['orderstate']=='PRE'){
					$pstr="去付款";
					$class="defult"; 
				}elseif($dataTable[0]['orderstate']=='CANCEL'){
					$pstr="已取消";
					$class="order_info";
				}elseif($dataTable[0]['orderstate']=='DELIVERING'){
					$pstr="已发货";
					$class="get";
				}elseif($dataTable[0]['orderstate']=='FINISH'){
					$pstr="已完成";
					$class="order_info";
				}
        ...
        <p style="margin:0px auto ; text-align:center; color:#F00;"><?=$pstr?></p>
   		</div> 
