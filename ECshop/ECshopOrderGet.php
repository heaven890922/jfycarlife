...
$sql="SELECT o.orderid,o.ordertime,o.paystate,o.money,o.ordernum,o.remarks,o.address,o.phone,o.`name`,o.expressPrice,d.price,d.num,gd.dpic,gd.dname,gs.gdname FROM sh_store_order o JOIN sh_store_order_detail d ON o.orderid=d.orderid JOIN sh_store_goods_detail gd ON d.goodsid=gd.detailid JOIN sh_store_goods gs ON gd.gdid=gs.gdid WHERE ordernum ='$orderNum'  AND userid=$userID and o.delstate='N' and o.orderstate='DELIVERING'  ";
...
?>
<h1>
  <div style="height:30px; font-size:18px;">确认收货</div></h1>
    ...
    <!--所选商品展示开始-->   
    	...
    	<div id="container"> 
     	...
     	<a href="#" class="ui-btn ui-corner-all" style=" border-color:#88cc44; color:#88cc44; width:76%; margin:auto;  padding: 0.5em 1em;" onClick="get()">确认收货</a>
   		</div> 
        
        <?
		 }else{
		?>
        <p style="margin:30px auto ; text-align:center; color:#F00;">订单号丢失或订单号错误或订单已收货！</p>
        <?
		 }
		?>
    <!--存储地址信息和所提交商品的信息开始--> 
